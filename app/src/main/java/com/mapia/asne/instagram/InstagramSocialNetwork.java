...
package com.mapia.asne.instagram;
...
import com.mapia.sns.SocialPerson;
import com.mapia.asne.core.AccessToken;
import com.mapia.asne.core.OAuthActivity;
import com.mapia.asne.core.OAuthSocialNetwork;
import com.mapia.asne.core.SocialNetworkAsyncTask;
import com.mapia.asne.core.SocialNetworkException;
import com.mapia.asne.core.listener.OnCheckIsFriendCompleteListener;
import com.mapia.asne.core.listener.OnLoginCompleteListener;
import com.mapia.asne.core.listener.OnPostingCompleteListener;
import com.mapia.asne.core.listener.OnRequestAccessTokenCompleteListener;
import com.mapia.asne.core.listener.OnRequestAddFriendCompleteListener;
import com.mapia.asne.core.listener.OnRequestDetailedSocialPersonCompleteListener;
import com.mapia.asne.core.listener.OnRequestGetFriendsCompleteListener;
import com.mapia.asne.core.listener.OnRequestRemoveFriendCompleteListener;
import com.mapia.asne.core.listener.OnRequestSocialPersonCompleteListener;
import com.mapia.asne.core.listener.OnRequestSocialPersonsCompleteListener;
...
//    private final String INSTAGRAM_CALLBACK_URL = "oauth://ASNE";
     ...
     * @return {@link com.mapia.asne.core.AccessToken}
     */
    @Override
    public AccessToken getAccessToken() {
        return new com.mapia.asne.core.AccessToken(
    ...
    /**
     * Request {@link com.mapia.asne.core.AccessToken} of Instagram social network that you can get from onRequestAccessTokenCompleteListener
     * @param onRequestAccessTokenCompleteListener listener for {@link com.mapia.asne.core.AccessToken} request
     */
    @Override
    public void requestAccessToken(OnRequestAccessTokenCompleteListener onRequestAccessTokenCompleteListener) {
        super.requestAccessToken(onRequestAccessTokenCompleteListener);
        ((OnRequestAccessTokenCompleteListener) mLocalListeners.get(REQUEST_ACCESS_TOKEN))
                .onRequestAccessTokenComplete(getID(), new com.mapia.asne.core.AccessToken(
                        mSharedPreferences.getString(SAVE_STATE_KEY_OAUTH_TOKEN, null),
                        null
                ));
    }
    ...
    /**
     * Request user {@link com.mapia.asne.instagram.InstagramPerson} by userId - detailed user data
     * @param userId id of Instagram user
     * @param onRequestDetailedSocialPersonCompleteListener listener for {@link com.mapia.asne.instagram.InstagramPerson} request
     */
    @Override
